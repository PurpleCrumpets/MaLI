...
% produced. (Updated for Edinburgh)
% 
% Tim Churchfield
%
...
%pathCalibration = 'C:\Users\timch\OneDrive - University of Edinburgh\University\Year 5\Placement\Edinburgh\calibration\24_01_2020\optim\rotatingdrum20';
pathCalibration = 'C:\Users\timch\OneDrive - University of Edinburgh\University\Year 5\Placement\Edinburgh\calibration\24_01_2020\optim\rotatingdrum35';
%pathCalibration = 'C:\Users\timch\OneDrive - University of Edinburgh\University\Year 5\Placement\Edinburgh\calibration\24_01_2020\optim\rotatingdrum50';
...
RPMLabels = {'5 av','20 av','40 av'}; % No nnl
%xAxisLabel = 'RPM, Angle Type';
xAxisLabel = 'RPM'; % No nnl
...
%% Import Output Data
lengthList = 105; % length(listing);

%OutputData = cell(lengthList,7);
OutputData = cell(lengthList,4); % No nnl
